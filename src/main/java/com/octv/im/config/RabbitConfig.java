...
public class RabbitConfig {
    ...
    private static final String CLUSTER_MODEL_DISPATCH_MESSAGE_QUEUE = "cluster.model.queue." + getIp();
...
//        });
    ...
    //重试的Template
    @Bean  //"{\"code\":2,\"groupID\":10,\"username\":\"zhang\",\"msg\":\"在吗\",\"sendUserId\":\"zhang\"}"
...
//        });
    ...
    public org.springframework.amqp.core.Queue queue() {
        return new org.springframework.amqp.core.Queue(CLUSTER_MODEL_DISPATCH_MESSAGE_QUEUE, true);
    }

    private static String getIp() {
        try {
            log.info("localhost ipAddress" + InetAddress.getLocalHost().getHostAddress());
